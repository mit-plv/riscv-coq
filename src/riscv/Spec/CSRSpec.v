...
Fixpoint getCSR {p} {t} `{(Spec.Machine.RiscvMachine p t)} (arg_0__
           ...
           := match arg_0__ with
                                  ...
                                  Bind (Spec.Machine.getCSRField Spec.CSRField.TVM) (fun tvm =>
                                          Bind (Spec.Machine.getCSRField Spec.CSRField.MPRV) (fun mprv =>
                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.MPP) (fun mpp =>
                                                          Bind (Spec.Machine.getCSRField Spec.CSRField.MPIE)
                                                               (fun mpie =>
                                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.MIE)
                                                                       (fun mie =>
                                                                          Bind (Spec.Machine.getCSRField
                                                                                Spec.CSRField.MXL) (fun mxl =>
                                                                                  Bind (getCSR Spec.CSR.SStatus)
                                                                                       (fun sstatus =>
                                                                                          Return (Z.lor (Z.lor (Z.lor
                                                                                                                (Z.lor
                                                                                                                 (Z.lor
                                                                                                                  (Z.lor
                                                                                                                   (Z.lor
                                  ...
                                  Bind (Spec.Machine.getCSRField Spec.CSRField.STIP) (fun stip =>
                                          Bind (Spec.Machine.getCSRField Spec.CSRField.UTIP) (fun utip =>
                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.SSIP) (fun ssip =>
                                                          Bind (Spec.Machine.getCSRField Spec.CSRField.USIP)
                                                               (fun usip =>
                                                                  Return (Z.lor (Z.lor (Z.lor (Z.lor (Z.lor usip
                                                                                                            (Z.shiftl
                                                                                                             ssip 1))
                                                                                                     (Z.shiftl utip 4))
                                                                                              (Z.shiftl stip 5))
                                                                                       (Z.shiftl ueip 8)) (Z.shiftl seip
                                                                                 9))))))))
              | Spec.CSR.SIE =>
                                          ...
                                          Bind (Return 0) (fun utie =>
                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.SSIE) (fun ssie =>
                                                          Bind (Return 0) (fun usie =>
                                                                  Return (Z.lor (Z.lor (Z.lor (Z.lor (Z.lor usie
                                                                                                            (Z.shiftl
                                                                                                             ssie 1))
                                                                                                     (Z.shiftl utie 4))
                                                                                              (Z.shiftl stie 5))
                                                                                       (Z.shiftl ueie 8)) (Z.shiftl seie
                                                                                 9))))))))
              | Spec.CSR.MTVec =>
              ...
              | Spec.CSR.InstRet =>
                  Bind (Spec.Machine.getCSRField Spec.CSRField.MIR) (fun permS =>
                          Bind (Spec.Machine.getCSRField Spec.CSRField.SIR) (fun permU =>
                                  Bind Spec.Machine.getPrivMode (fun priv =>
                                          if (orb (Spec.Machine.PrivMode_beq priv Spec.Machine.Machine) (orb (andb
                                                                                                              (Spec.Machine.PrivMode_beq
                                                                                                               priv
                                                                                                             ...
                                                                                                             (andb
                                                                                                              ...
                                                                                                              (andb
                                                                                                               ...
                                                                                                               (Z.eqb
                                                                                                                permU
                                                                                                                1))))) : bool
                                          then Spec.Machine.getCSRField Spec.CSRField.MInstRet
                                          else Spec.Machine.raiseException 0 2)))
              | Spec.CSR.Time =>
                  Bind (Spec.Machine.getCSRField Spec.CSRField.MTM) (fun permS =>
                          Bind (Spec.Machine.getCSRField Spec.CSRField.STM) (fun permU =>
                                  Bind Spec.Machine.getPrivMode (fun priv =>
                                          if (orb (Spec.Machine.PrivMode_beq priv Spec.Machine.Machine) (orb (andb
                                                                                                              (Spec.Machine.PrivMode_beq
                                                                                                               priv
                                                                                                             ...
                                                                                                             (andb
                                                                                                              ...
                                                                                                              (andb
                                                                                                               ...
                                                                                                               (Z.eqb
                                                                                                                permU
                                                                                                                1))))) : bool
                                          then Bind (Spec.Machine.loadWord Spec.Machine.Execute 33603576)
                                                    (fun timerlo =>
                                                       Bind Spec.Machine.getXLEN (fun xlen =>
                                                               if xlen >= 32 : bool
                                                               then Bind (Spec.Machine.loadWord Spec.Machine.Execute
                                                                                                33603580)
                                                                         (fun timerhi =>
                                                                            Return (Z.lor (id (Z.shiftl timerhi 32)) (id
                                                                                           timerlo)))
                                                               else Return (id timerlo)))
                                          else Spec.Machine.raiseException 0 2)))
              | Spec.CSR.Cycle =>
                  Bind (Spec.Machine.getCSRField Spec.CSRField.MCY) (fun permS =>
                          Bind (Spec.Machine.getCSRField Spec.CSRField.SCY) (fun permU =>
                                  Bind Spec.Machine.getPrivMode (fun priv =>
                                          if (orb (Spec.Machine.PrivMode_beq priv Spec.Machine.Machine) (orb (andb
                                                                                                              (Spec.Machine.PrivMode_beq
                                                                                                               priv
                                                                                                             ...
                                                                                                             (andb
                                                                                                              ...
                                                                                                              (andb
                                                                                                               ...
                                                                                                               (Z.eqb
                                                                                                                permU
                                                                                                                1))))) : bool
                                          then Spec.Machine.getCSRField Spec.CSRField.MCycle
                                          else Spec.Machine.raiseException 0 2)))
              | Spec.CSR.MHPMCounter3 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter4 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter5 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter6 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter7 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter8 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter9 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter10 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter11 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter12 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter13 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter14 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter15 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter16 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter17 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter18 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter19 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter20 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter21 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter22 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter23 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter24 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter25 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter26 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter27 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter28 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter29 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter30 => Return (_-_ 1)
              | Spec.CSR.MHPMCounter31 => Return (_-_ 1)
              | Spec.CSR.MCounterEn =>
                          ...
                          Bind (Spec.Machine.getCSRField Spec.CSRField.MIR) (fun mir =>
                                  Bind (Spec.Machine.getCSRField Spec.CSRField.MTM) (fun mtm =>
                                          Bind (Spec.Machine.getCSRField Spec.CSRField.MCY) (fun mcy =>
                                                  Return (Z.lor (Z.lor (Z.lor mcy (Z.shiftl mtm 1)) (Z.shiftl mir 2))
                                                                (Z.shiftl mhpm 3))))))
              | Spec.CSR.MCause =>
                  Bind Spec.Machine.getXLEN (fun xlen =>
                                  ...
                                  Bind (Spec.Machine.getCSRField Spec.CSRField.SPP) (fun spp =>
                                          Bind (Spec.Machine.getCSRField Spec.CSRField.SPIE) (fun spie =>
                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.SIE) (fun sie =>
                                                          let base :=
                                                            (Z.lor (Z.lor (Z.lor (Z.lor (Z.shiftl mxr 19) (Z.shiftl sum
                                                                                         18)) (Z.shiftl spp 8))
                                                                          (Z.shiftl spie 5)) (Z.shiftl sie 1)) in
                                                          Bind Spec.Machine.getXLEN (fun xlen =>
                                                                  if xlen >= 32 : bool
                                                                  then Bind (Spec.Machine.getCSRField Spec.CSRField.MXL)
                                                                            (fun mxl =>
                                                                               Bind Spec.Machine.getPC (fun vpc =>
                                                                                       Return (Z.lor (Z.shiftl mxl 32)
                                                                                                     base)))
                                                                  else Return base))))))
              | Spec.CSR.STVec =>
                          ...
                          Bind (Spec.Machine.getCSRField Spec.CSRField.SIR) (fun sir =>
                                  Bind (Spec.Machine.getCSRField Spec.CSRField.STM) (fun stm =>
                                          Bind (Spec.Machine.getCSRField Spec.CSRField.SCY) (fun scy =>
                                                  Return (Z.lor (Z.lor (Z.lor scy (Z.shiftl stm 1)) (Z.shiftl sir 2))
                                                                (Z.shiftl shpm 3))))))
              ...
              | Spec.CSR.SATP =>
                  Bind (Spec.Machine.getCSRField Spec.CSRField.TVM) (fun tvm =>
                          Bind (when (Z.eqb tvm 1) (Spec.Machine.raiseException 0 2)) (fun _ =>
                                  Bind Spec.Machine.getXLEN (fun xlen =>
                                          Bind (Spec.Machine.getCSRField Spec.CSRField.MODE) (fun mode =>
                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.ASID) (fun asid =>
                                                          Bind (Spec.Machine.getCSRField Spec.CSRField.PPN) (fun ppn =>
                                                                  ...
                                                                  then Return (Z.lor (Z.lor (Z.shiftl mode 31) (Z.shiftl
                                                                                             asid 22)) ppn)
                                                                  else Return (Z.lor (Z.lor (Z.shiftl mode 60) (Z.shiftl
                                                                                             asid 44)) ppn)))))))
                          ...
                          Bind (Spec.Machine.getCSRField Spec.CSRField.SEIP) (fun seip =>
                                  Bind (Spec.Machine.getCSRField Spec.CSRField.UEIP) (fun ueip =>
                                          Bind (Spec.Machine.getCSRField Spec.CSRField.MTIP) (fun mtip =>
                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.STIP) (fun stip =>
                                                          Bind (Spec.Machine.getCSRField Spec.CSRField.UTIP)
                                                               (fun utip =>
                                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.MSIP)
                                                                       (fun msip =>
                                                                          Bind (Spec.Machine.getCSRField
                                                                                Spec.CSRField.SSIP) (fun ssip =>
                                                                                  Bind (Spec.Machine.getCSRField
                          ...
                          Bind (Spec.Machine.getCSRField Spec.CSRField.SEIE) (fun seie =>
                                  Bind (Return 0) (fun ueie =>
                                          Bind (Spec.Machine.getCSRField Spec.CSRField.MTIE) (fun mtie =>
                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.STIE) (fun stie =>
                                                          Bind (Return 0) (fun utie =>
                                                                  Bind (Spec.Machine.getCSRField Spec.CSRField.MSIE)
                                                                       (fun msie =>
                                                                          Bind (Spec.Machine.getCSRField
                                                                                Spec.CSRField.SSIE) (fun ssie =>
                                                                                  Bind (Return 0) (fun usie =>
                                                                                          Return (Z.lor (Z.lor (Z.lor
                                                                                                                (Z.lor
                                                                                                                 (Z.lor
...
Fixpoint setCSR {p} {t} `{(Spec.Machine.RiscvMachine p t)} (arg_0__
                  : Spec.CSR.CSR) (arg_1__ : t) : p unit
           := match arg_0__, arg_1__ with
              | Spec.CSR.MStatus, val =>
                  Bind (setCSR Spec.CSR.SStatus val) (fun _ =>
                          Bind (Spec.Machine.setCSRField Spec.CSRField.TSR (Utility.Utility.bitSlice val
                                  ...
                                  Bind (Spec.Machine.setCSRField Spec.CSRField.TW (Utility.Utility.bitSlice val 21
                                          ...
                                          Bind (Spec.Machine.setCSRField Spec.CSRField.TVM (Utility.Utility.bitSlice val
                                                                          20 21)) (fun _ =>
                                                  Bind (Spec.Machine.setCSRField Spec.CSRField.MPRV
                                                                                 (Utility.Utility.bitSlice val 17 18))
                                                       (fun _ =>
                                                          Bind (Spec.Machine.setCSRField Spec.CSRField.MPP
                                                                                         (Utility.Utility.bitSlice val
                                                                                          11 13)) (fun _ =>
                  ...
                  Bind (Spec.Machine.setCSRField Spec.CSRField.MXR (Utility.Utility.bitSlice val
                          ...
                          Bind (Spec.Machine.setCSRField Spec.CSRField.SUM (Utility.Utility.bitSlice val
                                  ...
                                  Bind (Spec.Machine.setCSRField Spec.CSRField.SPP (Utility.Utility.bitSlice val 8
                                                                  9)) (fun _ =>
                                          Bind (Spec.Machine.setCSRField Spec.CSRField.SPIE (Utility.Utility.bitSlice
                                                                          val 5 6)) (fun _ =>
                                                  Bind (Spec.Machine.setCSRField Spec.CSRField.SIE
                                                                                 (Utility.Utility.bitSlice val 1 2))
                                                       (fun _ =>
                                                          Bind (getCSR Spec.CSR.SStatus) (fun _ => Return tt))))))
              | Spec.CSR.STVec, val =>
                  ...
                  Bind (Spec.Machine.setCSRField Spec.CSRField.USIP usip) (fun _ =>
                          Bind (Spec.Machine.setCSRField Spec.CSRField.SSIP ssip) (fun _ =>
                                  Bind (Spec.Machine.setCSRField Spec.CSRField.MSIP msip) (fun _ =>
                                          Bind (Spec.Machine.setCSRField Spec.CSRField.UTIP utip) (fun _ =>
                                                  Bind (Spec.Machine.setCSRField Spec.CSRField.STIP stip) (fun _ =>
                                                          Bind (Spec.Machine.setCSRField Spec.CSRField.MTIP mtip)
                                                               (fun _ =>
                                                                  Bind (Spec.Machine.setCSRField Spec.CSRField.UEIP
                                                                                                 ueip) (fun _ =>
                                                                          Bind (Spec.Machine.setCSRField
                                                                                Spec.CSRField.SEIP seip) (fun _ =>
                                                                                  Spec.Machine.setCSRField
                                                                                  Spec.CSRField.MEIP meip))))))))
              | Spec.CSR.MIE, val =>
                  let usie := Utility.Utility.bitSlice val 0 1 in
                  let ssie := Utility.Utility.bitSlice val 1 2 in
              ...
              | Spec.CSR.SATP, val =>
                  Bind Spec.Machine.getPrivMode (fun priv =>
                          Bind (Spec.Machine.getCSRField Spec.CSRField.TVM) (fun tvm =>
                                  Bind (when (andb (Spec.Machine.PrivMode_beq priv Spec.Machine.Supervisor) (Z.eqb
                                                    tvm 1)) (Spec.Machine.raiseException 0 2)) (fun _ =>
                                          Bind Spec.Machine.getXLEN (fun xlen =>
                                                  let mode :=
                                                    if Z.eqb xlen 32 : bool
                                                    then Utility.Utility.bitSlice val 31 32
                                                    else Utility.Utility.bitSlice val 60 64 in
                                                  when (Coq.Lists.List.In mode (cons 1 (cons 8 (cons 9 nil)))) (if Z.eqb
                                                                                                                   xlen
                                                                                                                   32 : bool
                                                                                                                then Bind
                                                                                                                     (Spec.Machine.setCSRField
...
(* External variables:
     Bind Return Z.eqb Z.land Z.lnot Z.lor Z.neg Z.shiftl Z.sub andb bool cons id nil
     op_zgze__ op_zm__ orb tt unit when Coq.Lists.List.In Spec.CSR.CSR Spec.CSR.Cycle
     Spec.CSR.FCSR Spec.CSR.FFlags Spec.CSR.FRM Spec.CSR.InstRet Spec.CSR.MCause
     ...
     Spec.Machine.Execute Spec.Machine.Machine Spec.Machine.PrivMode_beq
     Spec.Machine.RiscvMachine Spec.Machine.Supervisor Spec.Machine.User
     Spec.Machine.getCSRField Spec.Machine.getPC Spec.Machine.getPrivMode
     Spec.Machine.getXLEN Spec.Machine.loadWord Spec.Machine.raiseException
     Spec.Machine.setCSRField Utility.Utility.MachineInt Utility.Utility.bitSlice
*)
