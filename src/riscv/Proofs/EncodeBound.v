...
Proof. intros. unfold encode_Fence. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.

Lemma encode_Invalid_bitSlice_idemp: forall z,
     bitSlice (encode_Invalid z) 0 32 = encode_Invalid z.
Proof. intros. unfold encode_Invalid. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
...
Proof. intros. unfold encode_I. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
...
Proof. intros. unfold encode_I_shift_57. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
...
Proof. intros. unfold encode_I_shift_66. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
...
Proof. intros. unfold encode_I_system. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
...
Proof. intros. unfold encode_R_atomic. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
...
Proof. intros. unfold encode_R. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
...
Proof. intros. unfold encode_SB. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
...
Proof. intros. unfold encode_S. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.

Lemma encode_UJ_bitSlice_idemp: forall opcode r z,
    bitSlice (encode_UJ opcode r z) 0 32 =
              encode_UJ opcode r z.
Proof. intros. unfold encode_UJ. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.

Lemma encode_U_bitSlice_idemp: forall opcode r z,
    bitSlice (encode_U opcode r z) 0 32 =
              encode_U opcode r z.
Proof. intros. unfold encode_U. (unfold bitSlice in *; prove_Zeq_bitwise). Qed.
